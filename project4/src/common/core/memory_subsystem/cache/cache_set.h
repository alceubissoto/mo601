...
class CacheSet
{
   ...
   public:
      ...
      void read_line(UInt32 line_index, UInt32 offset, Byte *out_buff, UInt32 bytes, bool update_replacement, IntPtr eip);
      void write_line(UInt32 line_index, UInt32 offset, Byte *in_buff, UInt32 bytes, bool update_replacement, IntPtr eip);
      ...
      virtual void updateReplacementEIP(UInt32, IntPtr) {};
